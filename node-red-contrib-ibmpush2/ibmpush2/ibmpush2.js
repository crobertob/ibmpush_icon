...
//
RED.httpAdmin.get('/ibmpush2/vcap', function(req,res) {
    res.json({
    	isBluemix : isBluemix,
    	isBound : isBound
    });
...
RED.httpAdmin.get('/ibmpush2/:id', function(req,res) {
...
RED.httpAdmin.delete('/ibmpush2/:id', function(req,res) {
    RED.nodes.deleteCredentials(req.params.id);
    res.sendStatus(200);
});

RED.httpAdmin.post('/ibmpush2/:id', function(req,res) {
...
RED.nodes.registerType("ibmpush2", IBMPushNode2);
